...
function createSign(n, t) {
  ...
  function o(n, t, o, e, u, p, r) {
    var i
    return (n = h(n, h(h(((i = t) & o) | (~i & e), u), r))), h(f(n, p), t)
  }

  function e(n, t, o, e, u, p, r) {
    var i
    return (n = h(n, h(h((t & (i = e)) | (o & ~i), u), r))), h(f(n, p), t)
  }

  function u(n, t, o, e, u, p, r) {
    return (n = h(n, h(h(t ^ o ^ e, u), r))), h(f(n, p), t)
  }

  function p(n, t, o, e, u, p, r) {
    return (n = h(n, h(h(o ^ (t | ~e), u), r))), h(f(n, p), t)
  }
  ...
  function r(n) {
    var t,
      ...
      e = ''
    for (t = 0; t <= 3; t++) {
      o += (e = '0' + ((n >>> (8 * t)) & 255).toString(16)).substr(
        e.length - 2,
        2,
      )
    }
  ...
  for (
    ...
    ;(v = o((c = v), (g = d), (a = y), (s = b), i[l + 0], 7, 3614090360)),
      ...
      (v = e(
        v,
        (d = o(d, y, b, v, i[l + 15], 22, 1236535329)),
        y,
        b,
        i[l + 1],
        5,
      ...
      (v = u(
        v,
        (d = e(d, y, b, v, i[l + 12], 20, 2368359562)),
        y,
        b,
        i[l + 5],
        4,
      ...
      (v = p(
        v,
        (d = u(d, y, b, v, i[l + 2], 23, 3299628645)),
        y,
        b,
        i[l + 0],
        6,
